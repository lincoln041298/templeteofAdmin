...
export function Notification() {
  ...
  const displaytime =
    ...
    <div className="relative">
      <div className="dot-red" ref={node} onClick={()=> handleClickNotice(isActive)}>
        <img className="mx-5 pt-1 w-5" src={bell} alt="notification" />
      </div>
      <div className={`${isActive && `active`} menu-avatar absolute w-[350px] right-4 top-8 rounded-lg bg-white shadow-xl p-5`}>
          ...
          <li className="flex mb-3">
            ...
            <div className="w-full">
              <div className="flex items-center justify-between">
                ...
                <p className="text-xs text-slate-400 ml-auto whitespace-nowrap">06:05AM</p>
              </div>
              <p className="line-clamp-1 w-full text-slate-500 mt-0.5">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed
                deserunt quidem non mollitia labore eum facilis accusamus, nam
          ...
          <li className="flex mb-3">
            ...
            <div className="w-full">
              <div className="flex items-center justify-between">
                ...
                <p className="text-xs text-slate-400 ml-auto whitespace-nowrap">05:09AM</p>
              </div>
              <p className="line-clamp-1 w-full text-slate-500 mt-0.5">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed
                deserunt quidem non mollitia labore eum facilis accusamus, nam
          ...
          <li className="flex mb-3">
            ...
            <div className="w-full">
              <div className="flex  items-center justify-between">
                ...
                <p className="text-xs text-slate-400 ml-auto whitespace-nowrap">1:15PM</p>
              </div>
              <p className="line-clamp-1 w-full text-slate-500 mt-0.5">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed
                deserunt quidem non mollitia labore eum facilis accusamus, nam
